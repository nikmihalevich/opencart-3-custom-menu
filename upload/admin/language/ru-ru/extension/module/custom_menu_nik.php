...
$_['text_main']        = 'Главная';
$_['text_product_catalog'] = 'Каталог товаров';
$_['text_tools']       = 'Строительные инструменты';
$_['text_tea_products']= 'Чайная продукция';
$_['text_link_classmates'] = 'Ссылка на одноклассники';
$_['text_articles']    = 'Статьи';
$_['text_article_1']   = 'Статья 1';
$_['text_article_2']   = 'Статья 2';
...
$_['entry_menu_view']  = 'Вид меню';
$_['entry_display_type'] = 'Способ раскрытия меню';
$_['entry_parent_item']= 'Родительский пункт';
$_['entry_name_item']  = 'Название пункта';
$_['entry_link']       = 'Ссылка';
...
$_['help_menu_item']   = 'Можно поместить либо меню, либо модуль';
